...
Run the structural review inline: follow the process defined in `.claude/skills/structural-review/SKILL.md` against the changes in this branch (`git diff main..HEAD`). You already have the diff from Step 1 — reuse it rather than re-fetching.
